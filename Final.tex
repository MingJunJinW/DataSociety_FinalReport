...
\title{
    \vspace*{2cm}
    \textbf{Pipeline Bias in AI Training}
    \vspace{1cm}
}

\author{
    Demetrius Ho Sang \and
    Danny Roeder \and
    Nicole Lin \and
    MingJun Jin \and
    Thomas Wheelock\\[0.5cm]
    Rensselaer Polytechnic Institute\\
    CSCI 4370/6370: Data and Society
}
...
AI systems “learn” from data, and in doing so they inherit the biases and power imbalances present in that data. When models are used in health care, employment, credit scoring, or policing, these biases can translate into systematic harms for already disadvantaged communities.\\

Most policy and technical discussions focus on model behavior after deployment: explainability tools, output audits, or bans on specific high-risk applications. We argue that this focus is too narrow. Many problems start much earlier in the AI
pipeline, long before a model is fine-tuned or evaluated. This paper asks:
\emph{How should policy target the upstream stages of AI development in order to reduce bias before deployment?}

\mbox{}\\[0.5em]



\section{Background: The AI Training Pipeline and Bias}

\begin{minipage}{0.5\textwidth}
        At each stage, developers make choices that can systemically advantage majority groups or disadvantage minority groups alongside other hidden biases. We argue that “model bias” is better understood as \emph{pipeline bias} and that policies for regulating data collection and AI development should be designed with this in mind.
\end{minipage}
    \hfill
\begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{AI_Pipeline.png}
\end{minipage}
...
Data sourcing is a topic that most companies choose not to discuss. Models can require trillions of points of data for training \cite{lamarr_bias}, and this data has to come from somewhere. Therefore, in order to meet the demands of modern AI models, companies cut corners wherever possible. This can take the form of scraping data without consent, or using pre-existing data sets that may be outdated \cite{king_privacy}. Even if companies collect data in a more legitimate fashion, they can still fall victim to many different types of polling biases depending on how the data is collected. This can easily lead to limited diversity in the training data, causing model bias down the line.
...
\begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{AI_Pipeline_Monitor.png}
\end{minipage}
...
\section{Policy Proposals: Guardrails for Responsible AI Pipelines}
...
\subsection{Transparency Requirements for Training Data and Risks}
...
\subsection{Human Oversight Across the Pipeline}
...
\subsection{Mandatory Data Documentation}
...
Another limitation that these policies don't cover is the punishments for breaking these policies. If punishment is too little, companies will likely just shoulder the cost of breaking the rules rather than change how they are operating.


\newpage

\section*{Contributions}
Demetrius Ho Sang - Formatting/Editing, Case Studies(3), Bias within Health(3.1), Facial Recognition(3.2), AI Art(3.3), Citations/References
\\\newline Danny Roeder - Formatting/Editing, Abstract, Introduction(1), Background(2), Training(2.5), Bias Reviews(4.4), Discussion(5), Citations/References
\\\newline Mingjun Jin - Title, Table of Contents, Abstract, Introduction(1), Background(2), Deployment(2.7), Discussions(5), Citations/References
\\\newline Nicole Lin - Formatting/Editing, Abstract, Introduction(1), Pre-Processing(2.4), Pre-training(2.4), Testing(2.6), Documentation(4.3)
\\\newline Thomas Wheelock - Abstract, Problem Definition(2.1), Data Sourcing(2.2), Transparency(4.1), Human Oversight(4.2), Documentation(4.3), Incentives(4.5)


\begin{thebibliography}{99}

\bibitem{lamarr_bias}
“Ethical Use of Training Data: Ensuring Fairness \& Data Protection in AI,” Lamarr Institute for Machine Learning and Artificial Intelligence, Jul. 03, 2024.
\url{https://lamarr-institute.org/blog/ai-training-data-bias/}. Accessed:
Dec. 2, 2025.

\bibitem{king_privacy}
J. King and C. Meinhardt, “Rethinking Privacy in the AI Era Policy Provocations for a Data-Centric World,” Feb. 2024. Available: \url{https://hai.stanford.edu/assets/files/2024-02/White-Paper-Rethinking-Privacy-AI-Era.pdf}
Accessed: Dec. 3, 2025.

\bibitem{ibm_model_training}
IBM, “Model training,” Ibm.com, Feb. 13, 2025. 
\url{https://www.ibm.com/think/topics/model-training}. Accessed: Dec. 2, 2025.

\bibitem{obermeyer2019}
Z. Obermeyer, B. Powers, C. Vogeli, and S. Mullainathan, “Dissecting Racial Bias in an Algorithm Used to Manage the Health of Populations,” Science, vol. 366, no. 6464, pp. 447–453, Oct. 2019, doi: \url{https://doi.org/10.1126/science.aax2342}.
Accessed: Dec. 3, 2025.

\bibitem{nistfrvt}
P. Grother, M. Ngan, and K. Hanaoka, “Face recognition vendor test (FRVT) part 3: Demographic effects,” Face Recognition Vendor Test (FRVT) Part 3: Demographic Effects, vol. 8280, Dec. 2019, doi: \url{https://doi.org/10.6028/nist.ir.8280}.
Accessed: Dec. 3, 2025.

\bibitem{laion5b}
C. Schuhmann et al., “LAION-5B: An open large-scale dataset for training next generation image-text models,” arXiv:2210.08402 [cs], Oct. 2022, Available: \url{https://arxiv.org/abs/2210.08402}
Accessed: Dec. 3, 2025.
‌
\bibitem{martinez_mortgage}
E. Martinez and L. Kirchner, “The Secret Bias Hidden in Mortgage-Approval Algorithms – The Markup,” themarkup.org, Aug. 25, 2021. \url{https://themarkup.org/denied/2021/08/25/the-secret-bias-hidden-in-mortgage-approval-algorithms} 
Accessed: Dec. 3, 2025.
‌
